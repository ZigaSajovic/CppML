...
template <> struct Pivot<2> {
  ...
  using f = ml::DelayedEval<Pivot<_Pivot::GetNext::f<N::value - 2>::value>,
                            sizeof...(Ts), Pipe, ml::Int<N::value - 2>, Ts...,
                            T0, T1>;
};
...
template <> struct Pivot<4> {
  ...
  using f = ml::DelayedEval<Pivot<_Pivot::GetNext::f<N::value - 4>::value>,
                            sizeof...(Ts), Pipe, ml::Int<N::value - 4>, Ts...,
                            T0, T1, T2, T3>;
};
...
template <> struct Pivot<8> {
  template <typename Pipe, typename N, typename T0, typename T1, typename T2,
            ...
            typename... Ts>
  using f = ml::DelayedEval<Pivot<_Pivot::GetNext::f<N::value - 8>::value>,
...
template <> struct Pivot<16> {
  ...
  using f = ml::DelayedEval<Pivot<_Pivot::GetNext::f<N::value - 16>::value>,
                            sizeof...(Ts), Pipe, ml::Int<N::value - 16>, Ts...,
...
template <> struct Pivot<32> {
  ...
  using f = ml::DelayedEval<Pivot<_Pivot::GetNext::f<N::value - 32>::value>,
...
template <int N, typename Pipe = ml::ToList> struct Pivot {
  ...
  using f = ml::DelayedEval<
      Implementations::Pivot<Implementations::_Pivot::GetNext::f<N>::value>,
      sizeof...(Ts), Pipe, ml::Int<N>, Ts...>;
};
} // namespace ml
#endif
