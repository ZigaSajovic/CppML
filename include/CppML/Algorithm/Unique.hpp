...
template <bool Take> struct UniqueGet {
  template <typename I, typename Comparator, typename Pipe, typename T,
            typename... Ts>
  using f =
      ml::f<ml::DelayedEval<Detail::Unique<(I::value > 1)>, sizeof...(Ts)>,
...
struct Unique {
  ...
  using f =
      ml::f<ml::DelayedEval<Detail::Unique<static_cast<bool>(sizeof...(Ts))>,
                            sizeof...(Ts)>,
            ml::Int<sizeof...(Ts)>, Comparator, Pipe, Ts...>;
};
} // namespace Implementations
