...
void run() {
  {
    using T =
        ml::f<ml::Tail<37, ml::F<List>>, ml::Int<0>, ml::Int<1>, ml::Int<2>,
    ...
    static_assert(
        std::is_same<
            T, List<ml::Int<2>, ml::Int<3>, ml::Int<4>, ml::Int<5>, ml::Int<6>,
                    ...
                    ml::Int<31>, ml::Int<32>, ml::Int<33>, ml::Int<34>,
                    ml::Int<35>, ml::Int<36>, ml::Int<37>, ml::Int<38>>>::value,
        "Tail with a non-empty pack 37");
  }
}
}; // namespace TailTest
